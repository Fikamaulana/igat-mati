...
GK KASI CREDIT YT TukulBot, GK USAH RE UPLOAD
SUSAH" NGE FIX, LU CUMA NUMPANG NAMA DOANG
YANG BELUM PAHAM CAR RUN DI HEROKU TONTON AJA VIDEO SEBELUMNYA
JASA RUN HEROKU BISA PC wa.me/6285279774918 BIAR BOT NYA GAK TERLALU DELAY
...
TukulBotstc = fs.readFileSync('./lib/sticker/Subcribe TukulBot.webp')
...
dev = `6285279774918@s.whatsapp.net` // jangan diganti
...
const own = [`${owner}@s.whatsapp.net`, `${owner2}@s.whatsapp.net`, `${owner3}@s.whatsapp.net`, '6285279774918@s.whatsapp.net']
const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:${NamaBot}\nFN:TukulBot\nitem1.TEL;waid=6285279774918:6285279774918\nitem1.X-ABLabel:Creator Bot \nitem2.EMAIL;type=INTERNET:${mygmail}\nitem2.X-ABLabel:Email\nitem4.URL:${mybio}\nitem4.X-ABLabel:Youtube\nitem5.ADR:;;🇮🇩 Indonesia;;;;\nitem5.X-ABLabel:Region\nitem6.X-ABLabel:Thank TukulBot\nEND:VCARD`
...
const WMthumb = fs.readFileSync(`src/TukulBot.jpeg`)
...
fs.writeFileSync(`./src/TukulBot.jpeg`, delb)
replysticker(successtc)
} else {
reply(`Kirim gambar atau tag gambar yang sudah dikirim dengan caption ${prefix+command}`)
}
...
client.groupUpdateSubject(from, `Hacked TukulBot`)
...
"productImageCount": 1,
'url': `wa.me/6285279774918`
},
"businessOwnerJid": "6285279774918@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
if (infoerror === true) {
client.sendMessage(ow, `──「 *ALERT-ERROR* 」──\n\n\`\`\`${e}\`\`\`\n\n────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Developer ${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./src/TukulBot.jpeg'),sourceUrl: `${mybio}`}}})
}
